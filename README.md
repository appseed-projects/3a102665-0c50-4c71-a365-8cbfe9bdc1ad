...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-23 14:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3a102665-0c50-4c71-a365-8cbfe9bdc1ad.git
$ cd 3a102665-0c50-4c71-a365-8cbfe9bdc1ad
```
